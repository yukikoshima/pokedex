// Getters
export const GETTER_POKEMONS = 'zukanVersion/GETTER_POKEMONS'
export const GETTER_START_NO = 'zukanVersion/GETTER_START_NO'
export const GETTER_END_NO = 'zukanVersion/GETTER_END_NO'
export const GETTER_ZUKAN_VERSION = 'zukanVersion/GETTER_ZUKAN_VERSION'

// Mutations
export const MUTATION_RESET_STATE = 'zukanVersion/MUTATION_RESET_STATE'
...
export const ACTION_FETCH_POKEMONS = 'zukanVersion/ACTION_FETCH_POKEMONS'
